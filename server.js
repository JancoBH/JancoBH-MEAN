...
mongodb.MongoClient.connect(process.env.MONGODB_URI || "mongodb://heroku_863442xw:r6fa3as9ig2a2ng4omvccr5fnb@ds141815.mlab.com:41815/heroku_863442xw", function (err, client) {
  if (err) {
    console.log(err);
    process.exit(1);
  }
